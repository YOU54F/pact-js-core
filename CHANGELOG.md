...
* add optional logFile argument for ConsumerPact/ConsumerMessagePact/VerifierOptions ([02c8d19](https://github.com/you54f/pact-js-core/commit/02c8d194fe76a0a8e42ebdbe90080dd52c640b6f))
* add pactffi_given_with_params for params ([#476](https://github.com/you54f/pact-js-core/issues/476)) ([ed8dea8](https://github.com/you54f/pact-js-core/commit/ed8dea8ea1d2b006bdb16922a96f7ca0463fc2de))
* add pactffi_message_with_metadata_v2 ([#493](https://github.com/you54f/pact-js-core/issues/493)) ([613b7bd](https://github.com/you54f/pact-js-core/commit/613b7bd25e8ad2d673961e4c06be83d10ceb5b7b))
* allow setting of LOG_LEVEL env var ([7224770](https://github.com/you54f/pact-js-core/commit/72247702e1868286c09988764f93ac4aad68dfdb))
* ARM64 Linux/MacOS Pact Ruby Standalone ([ea9f86f](https://github.com/you54f/pact-js-core/commit/ea9f86f75a287425dfc1aa9b2124b9c892ec7672))
* build platform/arch specific npm packages ([27f9289](https://github.com/you54f/pact-js-core/commit/27f9289f3e1f1a4ac20b94cd2aa7e7e6b524bcc3))
* Prebuild pact_ffi pact.node - ([6a38cf7](https://github.com/you54f/pact-js-core/commit/6a38cf7cf2738e43e84586446fcaa8022d9e2431))
* provide musl arm64/x86_64 prebuilds ([2d4db39](https://github.com/you54f/pact-js-core/commit/2d4db3918b28afe25e770ed3fbadca025faed20d))
* Remove all classes that were backed by the Ruby implementation (Publisher; Message; Server; AbstractService; Stub; CanDeploy; CannotDeployError). Also remove the Pact() methods that called them (createServer; listServer; removeAllServers; createStub; listStub; createMessage; publishPacts). If you need these features, please use @pact-foundation/pact-cli ([e9f569b](https://github.com/you54f/pact-js-core/commit/e9f569b5a72279b522a21ad18809279acfe54be1))
* Remove the Ruby verifier and the associated CLI stubs (pact-broker, pact-message, pact-mock-service, pact-provider-verifier, pact-stub-service, pact, and pactflow). These have moved to @pact-foundation/pact-cli ([8e4f735](https://github.com/you54f/pact-js-core/commit/8e4f735c3628d7155b4451d7254a801b86b19d8a))
* support status code matcher via pactffi_response_status_v2 ([#486](https://github.com/you54f/pact-js-core/issues/486)) ([0edd3ac](https://github.com/you54f/pact-js-core/commit/0edd3aca29fad38211a87b44d187c5851814876d))


### Fixes and Improvements

* 🐛 avoid node-gyp rebuild install script ([f5f5e7c](https://github.com/you54f/pact-js-core/commit/f5f5e7cc387a7e694552fd5f69ba9c83ba490006))
* add deprecation warnings for pact cli tools in pact-js-core ([6292535](https://github.com/you54f/pact-js-core/commit/62925355646d7cb6abd4331cbfaf9c29a91926a9))
* bump version for release on fork ([c9f40d2](https://github.com/you54f/pact-js-core/commit/c9f40d28209e44e8d4bcfcbb1b92db183b9ad721))
* **deps:** pin to node 22.4.1 ([#518](https://github.com/you54f/pact-js-core/issues/518)) ([a3d97d2](https://github.com/you54f/pact-js-core/commit/a3d97d2d91d06e1dd0875fa0cd3e2cc331435bb4))
* **deps:** update dependency check-types to v7.4.0 ([30ff204](https://github.com/you54f/pact-js-core/commit/30ff204ea4988ecef56ebef223880e3e44abd7c7))
* **deps:** update dependency underscore to v1.13.7 ([921f692](https://github.com/you54f/pact-js-core/commit/921f6926955c74c45b33168da3aeb66c1b673ccd))
* drop support for node 15 and earlier ([5fa91db](https://github.com/you54f/pact-js-core/commit/5fa91db208bcceb176665722520519e4cfb5dc93))
* export pactffiMessageGivenWithParams ([9b77d8c](https://github.com/you54f/pact-js-core/commit/9b77d8cfa0897661d4f73a8d7483ff9bacff7e66))
* improve logging output for pact ffi native library lookup ([fb4e338](https://github.com/you54f/pact-js-core/commit/fb4e3383c5fccaa03350004b4086d01ff54cf585))
* logFile default to info if undefined, warn if error setting ([a9906c4](https://github.com/you54f/pact-js-core/commit/a9906c486f17832058148fc3b2d62b403a1909d1))
* node doesn't run .bat files on windows ([#504](https://github.com/you54f/pact-js-core/issues/504)) ([4f125b3](https://github.com/you54f/pact-js-core/commit/4f125b32bc3bdfc5e9bfbbef4e0302073783dcf1))
* normalise PREBUILD_NAME to node.napi ([3812b0d](https://github.com/you54f/pact-js-core/commit/3812b0def2559492c0ad4608db062e7c53526fec))
* pactffi_given_with_params accepts 3 args ([a56fdf7](https://github.com/you54f/pact-js-core/commit/a56fdf7f40b13765ea058e2fc70abebe1a185211))
* path lookup for binaries was incorrectly munging into a single path ([7203e10](https://github.com/you54f/pact-js-core/commit/7203e1064deb28a79aa92da0edfa28bac604c38b))
* prevent node-gyp rebuild on fresh install ([c24c638](https://github.com/you54f/pact-js-core/commit/c24c638bc86cab98793ace6b5488de25ca242c85)), closes [/www.linen.dev/s/pact-foundation/t/16633868/hell-all-quick-question-in-the-migration-guide-for-v12-it-s-#100081d7-2fee-4420-8eac-d55858dcc483](https://github.com/you54f//www.linen.dev/s/pact-foundation/t/16633868/hell-all-quick-question-in-the-migration-guide-for-v12-it-s-/issues/100081d7-2fee-4420-8eac-d55858dcc483) [/github.com/npm/cli/issues/5234#issuecomment-1291139150](https://github.com/you54f//github.com/npm/cli/issues/5234/issues/issuecomment-1291139150)
* Remove check for windows long paths as it was only relevant to the Ruby binaries ([e7778da](https://github.com/you54f/pact-js-core/commit/e7778dacf5428282080ba7b3feaf5447a4968fb3))
...
* set engines in package.json not engine ([4c9cc69](https://github.com/you54f/pact-js-core/commit/4c9cc695a02c52c546c30379a92c5b9008888b4e))
* set process.stdout._handle.setBlocking(true) on ffi init ([#510](https://github.com/you54f/pact-js-core/issues/510)) ([af76abd](https://github.com/you54f/pact-js-core/commit/af76abd64b034d2c0e1ffdbe795d68ed8d791b1e))
* shell escaping ([#511](https://github.com/you54f/pact-js-core/issues/511)) ([3829d20](https://github.com/you54f/pact-js-core/commit/3829d2024b6f8cb9790899ae068d14e74f9837d0))
* update pact-ffi to 0.4.16 ([502f354](https://github.com/you54f/pact-js-core/commit/502f354290b872a6ca2830d5f880560aa0401df1))
* update pact-ffi to 0.4.20 ([7a91725](https://github.com/you54f/pact-js-core/commit/7a9172536393ac667b067fb57ba3b73363d9c87b))
* update standalone to 1.92.0 ([0287ce8](https://github.com/you54f/pact-js-core/commit/0287ce8f36509ce16812269f065ca75d1b49672d))
* update standalone to 2.0.2 ([a6133f1](https://github.com/you54f/pact-js-core/commit/a6133f1cd1ee57908c055c2de64ad435edb62de3))
* update standalone to 2.0.3 ([b16a450](https://github.com/you54f/pact-js-core/commit/b16a450f4e6d7ed6cbdfa6192f36f11146ae4031))
* update standalone to 2.0.7 ([3234fae](https://github.com/you54f/pact-js-core/commit/3234faee368e59c50ec001c2aa80d7a1dba32b14))
* update standalone to 2.1.0 ([6b49009](https://github.com/you54f/pact-js-core/commit/6b490091623fa6f36899acbcfb41a14ebbf8da4a))
* update standalone to 2.4.0 ([f9a8e27](https://github.com/you54f/pact-js-core/commit/f9a8e27a606feb5ababc1f87b49c746dd33a04ce))
* update standalone to 2.4.1 ([8dfad86](https://github.com/you54f/pact-js-core/commit/8dfad86f7b00c890e798eb168fb0d4244101c5a8))
* update standalone to 2.4.2 ([#492](https://github.com/you54f/pact-js-core/issues/492)) ([fcccc34](https://github.com/you54f/pact-js-core/commit/fcccc34cf0891b277c3cd7053d4d5262ee23eac5))
* update standalone to 2.4.4 ([e7872d2](https://github.com/you54f/pact-js-core/commit/e7872d2cfcc107313b7bedc57291adc041fe68c3))
* update standalone to 2.4.6 ([46cb62c](https://github.com/you54f/pact-js-core/commit/46cb62c710245c1b72d74574d599bfa564ac2263))
* update to libpact_ffi 0.4.21 ([34c7612](https://github.com/you54f/pact-js-core/commit/34c7612a4b4c12c324a076d5c0234a9520509d83))
* upgrade to latest ffi 0.4.12 ([94447f4](https://github.com/you54f/pact-js-core/commit/94447f4aa2cd32f0b21747d4e82a63ffceab2a51))
* upgrade to latest ffi 0.4.15 ([1ebdc49](https://github.com/you54f/pact-js-core/commit/1ebdc4983a438368286ae36ae1de0f37424cd403))
* upgrade to latest ffi 0.4.19 ([7a7d9b0](https://github.com/you54f/pact-js-core/commit/7a7d9b0af6e5d9bfd2356f21808c48a407cf8a03))
* upgrade to latest ffi 0.4.6 ([56e3f4b](https://github.com/you54f/pact-js-core/commit/56e3f4bae914a5f0037c8cb7715f82fd354d6afb))
* upgrade to latest ffi 0.4.7 ([#462](https://github.com/you54f/pact-js-core/issues/462)) ([55f33c3](https://github.com/you54f/pact-js-core/commit/55f33c33962130d7a11af3add6451181c0b338bb))
* upgrade to latest ffi 0.4.9 ([6ddfda7](https://github.com/you54f/pact-js-core/commit/6ddfda7d43a1590d9dfcf7171c1afeffd228ac05))
* upgrade to latest needle to support no_proxy. Fixes [#351](https://github.com/you54f/pact-js-core/issues/351) ([30f46d0](https://github.com/you54f/pact-js-core/commit/30f46d071865a69c94a25381f371605e3a1667ed))
